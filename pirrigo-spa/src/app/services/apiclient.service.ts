...
export class ApiClientService {
  ...
  // ponytail: return Observable so caller can handle errors; was fire-and-forget
  postStationRun(body: StationRunRequestBody): Observable<StationResponse> {
    const uri = `${this._globals.uriStem}/station/run`
    return this._http.post<StationResponse>(
